 <div id="workerManage<?php echo $row2['booking_id']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
   <div class="modal-content">
    <form method="post" action="bookingManageE1Update.php?id=<?php echo $id;?>&id2=<?php echo $row2['booking_id'];?> ">
