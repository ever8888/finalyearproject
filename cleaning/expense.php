...
session_start();
	 ...
	 $result2=mysqli_query($link,"SELECT * FROM expense");
...
$success  = "";
    ...
    {  
        ...
        $sql = "INSERT INTO expense(expense_type,expense_amount,expense_desc)
        VALUES ('$type','$amount','$desc')";
  ...
  <a href="welcome.php"  ><i class="fa fa-dashboard"></i>&nbspDashboard</a>
    <a href="bookingCalendar.php"><i class="fa fa-calendar"></i> Calendar</a>
	  ...
	  <a href="customer.php"><i class="fa fa-user"></i>&nbsp Customer</a>
	   ...
	   <a href="" class="dash"><i class="fa fa-usd"></i>&nbsp Expenses</a>
...
$(document).ready(function()
{
	...
	$("#auto").load("nav2.php");
	 ...
	 <div class="cov">
	<h3>Manage Expense Data</h3>
	</div>
	
	
<?php
	$tw = mysqli_query($link, "SELECT SUM(expense_amount) FROM expense WHERE expense_type='Salary'");
...
<div class="box1">
	...
	<?php
	$tw2 = mysqli_query($link, "SELECT SUM(expense_amount) FROM expense WHERE expense_type='Tools'");
	...
	<?php
        	$tw3 = mysqli_query($link, "SELECT SUM(expense_amount) FROM expense WHERE expense_type='Promote'");
	...
	?>
	 ...
	 <?php
	$tw4 = mysqli_query($link, "SELECT SUM(expense_amount) FROM expense WHERE expense_type='Others'");
    ...
    <div class="container">
     ...
     <div class="col-sm-6">
	  ...
	  <input type="text" name="search"  id="search"  onkeyup="myFunction()"  style="width:360px;height:35px;;" class="form-control"placeholder="Search..by expense type" /> 
   ...
   $per_page_record = 10;
    if (isset($_GET["page"])) {    
        ...
        $query = "SELECT * FROM expense LIMIT $start_from, $per_page_record";     
...
<div id="servicetable">
    ...
    <?php
     ...
     <tr>
	 <?php
	 	if($row2["expense_type"]!="Salary")
		{
	 ?>
      <td><?php echo $row2["expense_type"]; ?></td>
      <td><?php echo $row2["expense_amount"]; ?></td>
      <td><?php echo $row2["expense_desc"]; ?></td>
	    
      <td>
           <a href="#edit<?php echo $row2['expense_id']; ?>" 
data-toggle="modal">
<span class="fa fa-edit">
	    ...
	    <a href='expenseDelete.php?id=<?php echo $row2["expense_id"]; ?>' ><i class="material-icons" data-toggle="tooltip" value="Delete">&#xE872;</i></a>
	   
     <?php include('expenseEdit.php'); ?>
      </td>
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='expense.php?page=".($page-1)."'>  Prev </a>";   
        }       
                   
        for ($i=1; $i<=$total_pages; $i++) {   
          if ($i == $page) {   
              $pagLink .= "<a class = 'active' href='expense.php?page="  
                                                .$i."'>".$i." </a>";   
          }               
          else  {   
              $pagLink .= "<a href='expense.php?page=".$i."'>   
                                                ".$i." </a>";     
          }   
        };     
        echo $pagLink;   
        ...
        if($page<$total_pages){   
            echo "<a href='expense.php?page=".($page+1)."'>  Next </a>";   
        }   
    ...
    <form method="post" action="expense.php">
     ...
     <div class="modal-body">     
      ...
      <div class="form-group">
       ...
       <input type="number" class="form-control" name="amount" placeholder="Enter expense amount" required>
      </div>
	   <div class="form-group">
       <label>Expense Description</label>
       <input type="text" class="form-control" name="desc" placeholder="Enter expense description" required>
      </div>
