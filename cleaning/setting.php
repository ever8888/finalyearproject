    ...
    <a href="bookingCalendar.php"><i class="fa fa-calendar"></i> Calendar</a>
	  ...
	  <a href="customer.php"><i class="fa fa-user"></i>&nbsp Customer</a>
	   ...
	   <a href="voucher.php"><i class="fa fa-tag"></i> Voucher</a>
		...
		<hr>
		<div class="set">
		<a href="" class="dash"><i class="fa fa-cog"></i></a>
	    </div>
  ...
  <div class="modal-dialog">
   ...
   <h3><b>&nbsp Set Business Off Date</b></h3>
		...
		<div class="form-group <?php echo (!empty($date_err)) ? 'has-error' : ''; ?>">
			<label><i class="" style="color:#2196F3; font-size: 30px; text-shadow:1px 1px 2px #000000;"></i> Date</label>
			...
			<br>
			 ...
			 <div class="form-group <?php echo (!empty($reason_err)) ? 'has-error' : ''; ?>">
                <label>Reason</label>
                <input type="text" name="reason" class="form-control"  value="<?php echo $reason; ?>" required>
