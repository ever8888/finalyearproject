...
enctype="multipart/form-data">
     ...
     <div class="form-group">
	  ...
	  ?>
       ...
       <input type="date" class="form-control" name="end" style="font-size:18px" value="<?php echo $erow['expiry_date']; ?>" required>
      </div>

	  
	    <div class="form-group">
       <label style="font-weight:bold;font-size:20px";>Voucher Status</label><br>
      
	   <?php
	   if($erow['voucher_status']==1)
	   {
		   ?>
