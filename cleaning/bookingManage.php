     ...
     <tr>
      ...
      <br><br>-Phone: <?php echo $row2["booking_phone"]; ?>
	   <br><br>-Address:<?php echo $row2["booking_address"]; ?>
	    ...
	    <br><br>-Time:<?php echo $row2["booking_time"]; ?></td>
		...
		?>
		<td><?php echo $row2["booking_status"]; ?></td>
      <td>
       
	   
	    <a href='bookingDelete.php?id=<?php echo $row2["booking_id"]; ?>' ><i class="material-icons" data-toggle="tooltip" value="Delete">&#xE872;</i></a>
