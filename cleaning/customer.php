...
<hr>
  <a href="welcome.php"  ><i class="fa fa-dashboard"></i>&nbspDashboard</a>
    <a href="bookingCalendar.php"><i class="fa fa-calendar"></i> Calendar</a>
	  ...
	  <a href="" class="dash"><i class="fa fa-user"></i>&nbsp Customer</a>
...
$(document).ready(function()
{
	...
	<?php
	$tw = mysqli_query($link, "SELECT COUNT('1') FROM customer");
...
<div class="box1">
	...
	<?php
	$tw2 = mysqli_query($link, "SELECT COUNT('1') FROM booking_history");
  ...
  <?php
	...
	<?php
		...
		$tw3=mysqli_query($link,"SELECT COUNT('1') FROM booking");
	...
	?>
	 ...
	 <?php
	$tw4 = mysqli_query($link, "SELECT SUM(cust_coin) AS total FROM customer");
 ...
 echo $countM4;
    ...
    <div class="container">
     ...
     <div class="col-sm-6"  >
	     ...
	     <input type="text" name="search" id="search"  onkeyup="myFunction()"  style="width:360px;height:35px;margin-left:200px;" class="form-control"placeholder="Search..by customer name" /> 
   ...
   $per_page_record = 30;
    if (isset($_GET["page"])) {    
        ...
        $query = "SELECT * FROM customer LIMIT $start_from, $per_page_record";     
...
<div id="servicetable">
    ...
    <?php
     ...
     <tr>
      ...
      <td><?php echo nl2br($row2["cust_phoneNo"]); ?></td>
	  
	  <td><?php echo $row2["cust_address"]; ?></td>
       <td><?php echo $row2["cust_coin"]; ?></td>	   
<td>
<a href="#edit<?php echo $row2['cust_id']; ?>" 
data-toggle="modal">
<span class="fa fa-edit">

</span></a>&nbsp;

     <?php include('customerEdit.php'); ?>
</td>
    ...
    echo "</br>";     
        ...
        if($page>=2){   
            echo "<a href='customer.php?page=".($page-1)."'>  Prev </a>";   
        }       
        ...
        if($page<$total_pages){   
            echo "<a href='customer.php?page=".($page+1)."'>  Next </a>";   
        }   
